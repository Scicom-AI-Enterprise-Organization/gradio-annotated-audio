import { c as Xn, a as Yn, g as Hn } from "./module-CdGbkDUx.js";
const Mt = /* @__PURE__ */ new Set(), Zn = Xn({
  deregister: ({ call: e }) => (t) => e("deregister", { port: t }, [t]),
  encode: ({ call: e }) => async (t, n) => {
    const r = await e("encode", { encoderId: t, timeslice: n });
    return Mt.delete(t), r;
  },
  instantiate: ({ call: e }) => async (t, n) => {
    const r = Yn(Mt), o = await e("instantiate", { encoderId: r, mimeType: t, sampleRate: n });
...
const tr = (e) => (t, n) => {
...
}, ir = (e, t, n, r, o, s, a) => class extends s {
  constructor(i, u = {}) {
    const { mimeType: d } = u;
...
}, cr = (e) => e !== null && e.BlobEvent !== void 0 ? e.BlobEvent : null, ur = (e, t, n) => {
  const r = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new WeakMap(), s = /* @__PURE__ */ new WeakMap(), a = new e(t, n), c = /* @__PURE__ */ new WeakMap();
  let i = !1;
  return a.addEventListener = /* @__PURE__ */ ((u) => (d, l, w) => {
    let m = l;
    if (typeof l == "function")
      if (d === "dataavailable") {
        const h = [];
        m = (f) => {
          i && a.state === "inactive" ? h.push(f) : l.call(a, f);
        }, r.set(l, h), o.set(l, m);
      } else d === "error" ? (m = (h) => {
        h instanceof ErrorEvent ? l.call(a, h) : l.call(a, new ErrorEvent("error", { error: h.error }));
      }, s.set(l, m)) : d === "stop" && (m = (h) => {
        for (const [f, g] of r.entries())
          if (g.length > 0) {
            const [p] = g;
            g.length > 1 && Object.defineProperty(p, "data", {
              value: new Blob(g.map(({ data: A }) => A), { type: p.data.type })
            }), g.length = 0, f.call(a, p);
          }
        i = !1, l.call(a, h);
      }, c.set(l, m));
    return u.call(a, d, m, w);
  })(a.addEventListener), a.removeEventListener = /* @__PURE__ */ ((u) => (d, l, w) => {
    let m = l;
    if (typeof l == "function") {
      if (d === "dataavailable") {
        r.delete(l);
    ...
    return u.call(a, d, m, w);
  })(a.removeEventListener), a.start = /* @__PURE__ */ ((u) => (d) => (i = d !== void 0, d === void 0 ? u.call(a) : u.call(a, d)))(a.start), a;
}, lr = (e) => e === null || e.MediaRecorder === void 0 ? null : e.MediaRecorder, Yt = () => {
  try {
  ...
  if (r === "binary") {
    ...
    for (let d = 0; d < i; d += 1) {
      const l = d * o + 1;
      for (let w = 0; w < o; w += 1)
        u[w][d] = t.getFloat32(n + a + (l + w) * Float32Array.BYTES_PER_ELEMENT, !0);
    }
...
}, Nt = Symbol.observable || "@@observable";
function pr(e) {
  return Symbol.observable || (typeof e == "function" && e.prototype && e.prototype[Symbol.observable] ? (e.prototype[Nt] = e.prototype[Symbol.observable], delete e.prototype[Symbol.observable]) : (e[Nt] = e[Symbol.observable], delete e[Symbol.observable])), e;
}
const Ne = () => {
}, Ot = (e) => {
  throw e;
...
const gr = (e) => (t, n, r) => e((o) => {
...
}, _r = wr(pr, mr), Ht = gr(_r), vr = (e, t, n) => async (r) => {
  ...
  const c = {
    ...
    numberOfInputs: 1,
    numberOfOutputs: 0
  }, i = new o(s, "recorder-audio-worklet-processor", {
    ...a,
    ...c
  }), u = /* @__PURE__ */ new Map(), d = t(u, i.port), l = n(i.port, "message")(e(u));
  i.port.start();
  let w = "inactive";
  return Object.defineProperties(i, {
    pause: {
      get() {
        return async () => (r(["recording"], w), w = "paused", d({
          method: "pause"
        }));
      }
    },
    ...
    record: {
      get() {
        return async (m) => (r(["inactive"], w), w = "recording", d({
          method: "record",
    ...
    resume: {
      get() {
        return async () => (r(["paused"], w), w = "recording", d({
          method: "resume"
        }));
      }
    },
    stop: {
      get() {
        return async () => {
          r(["paused", "recording"], w), w = "stopped";
          try {
            await d({ method: "stop" });
          } finally {
            l();
...
}, Cr = '(()=>{"use strict";class e extends AudioWorkletProcessor{constructor(){super(),this._encoderPort=null,this._numberOfChannels=0,this._state="inactive",this.port.onmessage=({data:e})=>{"pause"===e.method?"active"===this._state||"recording"===this._state?(this._state="paused",this._sendAcknowledgement(e.id)):this._sendUnexpectedStateError(e.id):"record"===e.method?"inactive"===this._state?(this._encoderPort=e.params.encoderPort,this._state="active",this._sendAcknowledgement(e.id)):this._sendUnexpectedStateError(e.id):"resume"===e.method?"paused"===this._state?(this._state="active",this._sendAcknowledgement(e.id)):this._sendUnexpectedStateError(e.id):"stop"===e.method?"active"!==this._state&&"paused"!==this._state&&"recording"!==this._state||null===this._encoderPort?this._sendUnexpectedStateError(e.id):(this._stop(this._encoderPort),this._sendAcknowledgement(e.id)):"number"==typeof e.id&&this.port.postMessage({error:{code:-32601,message:"The requested method is not supported."},id:e.id})}}process([e]){if("inactive"===this._state||"paused"===this._state)return!0;if("active"===this._state){if(void 0===e)throw new Error("No channelData was received for the first input.");if(0===e.length)return!0;this._state="recording"}if("recording"===this._state&&null!==this._encoderPort){if(void 0===e)throw new Error("No channelData was received for the first input.");return 0===e.length?this._encoderPort.postMessage(Array.from({length:this._numberOfChannels},()=>128)):(this._encoderPort.postMessage(e,e.map(({buffer:e})=>e)),this._numberOfChannels=e.length),!0}return!1}_sendAcknowledgement(e){this.port.postMessage({id:e,result:null})}_sendUnexpectedStateError(e){this.port.postMessage({error:{code:-32603,message:"The internal state does not allow to process the given message."},id:e})}_stop(e){e.postMessage([]),e.close(),this._encoderPort=null,this._state="stopped"}}e.parameterDescriptors=[],registerProcessor("recorder-audio-worklet-processor",e)})();', Tr = vr(Blob, URL, Cr), Mr = br(yr, Er(Hn), Ht, Ar), kt = (e, t, n) => ({ endTime: t, insertTime: n, type: "exponentialRampToValue", value: e }), It = (e, t, n) => ({ endTime: t, insertTime: n, type: "linearRampToValue", value: e }), Ke = (e, t) => ({ startTime: t, type: "setValue", value: e }), Zt = (e, t, n) => ({ duration: n, startTime: t, type: "setValueCurve", values: e }), Kt = (e, t, { startTime: n, target: r, timeConstant: o }) => r + (t - r) * Math.exp((n - e) / o), me = (e) => e.type === "exponentialRampToValue", Re = (e) => e.type === "linearRampToValue", re = (e) => me(e) || Re(e), ct = (e) => e.type === "setValue", J = (e) => e.type === "setValueCurve", Le = (e, t, n, r) => {
  const o = e[t];
  return o === void 0 ? r : re(o) || ct(o) ? o.value : J(o) ? o.values[o.values.length - 1] : Kt(n, Le(e, t - 1, o.startTime, r), o);
}, St = (e, t, n, r, o) => n === void 0 ? [r.insertTime, o] : re(n) ? [n.endTime, n.value] : ct(n) ? [n.startTime, n.value] : J(n) ? [
  n.startTime + n.duration,
  n.values[n.values.length - 1]
] : [
  n.startTime,
  Le(e, t - 1, n.startTime, o)
], Qe = (e) => e.type === "cancelAndHold", Je = (e) => e.type === "cancelScheduledValues", ne = (e) => Qe(e) || Je(e) ? e.cancelTime : me(e) || Re(e) ? e.endTime : e.startTime, Rt = (e, t, n, { endTime: r, value: o }) => n === o ? o : 0 < n && 0 < o || n < 0 && o < 0 ? n * (o / n) ** ((e - t) / (r - t)) : e < r ? n : o, Lt = (e, t, n, { endTime: r, value: o }) => n + (e - t) / (r - t) * (o - n), Qt = (e, t) => {
  const n = Math.floor(t);
  if (n === t)
    return e[n];
  const r = Math.ceil(t);
  return (1 - (t - n)) * e[n] + (1 - (r - t)) * e[r];
}, Nr = (e, { duration: t, startTime: n, values: r }) => {
  const o = (e - n) / t * (r.length - 1);
  return Qt(r, o);
}, Or = (e, t, n) => {
  const r = e.length, o = Math.max(1, Math.floor(n / t * r)) + 1, s = e instanceof Float32Array ? new Float32Array(o) : e.slice(0, o);
  for (let a = 0; a < o; a += 1) {
    const i = a / (o - 1) * n / t * (r - 1);
    s[a] = Qt(e, i);
  }
  return s;
...
class kr {
  ...
  add(t) {
    const n = ne(t);
    if (Qe(t) || Je(t)) {
      const r = this._automationEvents.findIndex((s) => Je(t) && J(s) ? s.startTime + s.duration >= n : ne(s) >= n), o = this._automationEvents[r];
      if (r !== -1 && (this._automationEvents = this._automationEvents.slice(0, r)), Qe(t)) {
        const s = this._automationEvents[this._automationEvents.length - 1];
        if (o !== void 0 && re(o)) {
          if (s !== void 0 && Oe(s))
            throw new Error("The internal list is malformed.");
          const a = s === void 0 ? o.insertTime : J(s) ? s.startTime + s.duration : ne(s), c = s === void 0 ? this._defaultValue : J(s) ? s.values[s.values.length - 1] : s.value, i = me(o) ? Rt(n, a, c, o) : Lt(n, a, c, o), u = me(o) ? kt(i, n, this._currenTime) : It(i, n, this._currenTime);
          this._automationEvents.push(u);
        }
        if (s !== void 0 && Oe(s) && this._automationEvents.push(Ke(this.getValue(n), n)), s !== void 0 && J(s) && s.startTime + s.duration > n) {
          const a = n - s.startTime;
          this._automationEvents[this._automationEvents.length - 1] = Zt(Or(s.values, s.duration, a), s.startTime, a);
        }
      }
    } else {
      ...
      if (o !== void 0 && J(o) && ne(o) + o.duration > n)
        return !1;
      const s = me(t) ? kt(t.value, t.endTime, this._currenTime) : Re(t) ? It(t.value, n, this._currenTime) : t;
      if (r === -1)
  ...
  flush(t) {
    ...
    if (n > 1) {
      ...
      Oe(o) && r.unshift(Ke(Le(this._automationEvents, n - 2, o.startTime, this._defaultValue), o.startTime)), this._automationEvents = r;
    }
  }
  getValue(t) {
    ...
    if (s !== void 0 && Oe(s) && (r === void 0 || !re(r) || r.insertTime > t))
      return Kt(t, Le(this._automationEvents, o - 1, s.startTime, this._defaultValue), s);
    if (s !== void 0 && ct(s) && (r === void 0 || !re(r)))
      return s.value;
    if (s !== void 0 && J(s) && (r === void 0 || !re(r) || s.startTime + s.duration > t))
      return t < s.startTime + s.duration ? Nr(t, s) : s.values[s.values.length - 1];
    if (s !== void 0 && re(s) && (r === void 0 || !re(r)))
      return s.value;
    if (r !== void 0 && me(r)) {
      const [a, c] = St(this._automationEvents, o, s, r, this._defaultValue);
      return Rt(t, a, c, r);
    }
    if (r !== void 0 && Re(r)) {
      const [a, c] = St(this._automationEvents, o, s, r, this._defaultValue);
...
const Ir = (e) => ({ cancelTime: e, type: "cancelAndHold" }), Sr = (e) => ({ cancelTime: e, type: "cancelScheduledValues" }), Rr = (e, t) => ({ endTime: t, type: "exponentialRampToValue", value: e }), Lr = (e, t) => ({ endTime: t, type: "linearRampToValue", value: e }), Pr = (e, t, n) => ({ startTime: t, target: e, timeConstant: n, type: "setTarget" }), Br = () => new DOMException("", "AbortError"), Ur = (e) => (t, n, [r, o, s], a) => {
...
}, ge = /* @__PURE__ */ new WeakSet(), Jt = /* @__PURE__ */ new WeakMap(), en = /* @__PURE__ */ new WeakMap(), tn = /* @__PURE__ */ new WeakMap(), nn = /* @__PURE__ */ new WeakMap(), rn = /* @__PURE__ */ new WeakMap(), on = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), tt = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new WeakMap(), sn = {
  construct() {
    return sn;
  }
}, Vr = (e) => {
  ...
  return !0;
}, Pt = /^import(?:(?:[\s]+[\w]+|(?:[\s]+[\w]+[\s]*,)?[\s]*\{[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?(?:[\s]*,[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?)*[\s]*}|(?:[\s]+[\w]+[\s]*,)?[\s]*\*[\s]+as[\s]+[\w]+)[\s]+from)?(?:[\s]*)("([^"\\]|\\.)+"|'([^'\\]|\\.)+')(?:[\s]*);?/, Bt = (e, t) => {
  const n = [];
  let r = e.replace(/^[\s]+/, ""), o = r.match(Pt);
  for (; o !== null; ) {
    const s = o[1].slice(1, -1), a = o[0].replace(/([\s]+)?;?$/, "").replace(s, new URL(s, t).toString());
    n.push(a), r = r.slice(o[0].length).replace(/^[\s]+/, ""), o = r.match(Pt);
  }
  return [n.join(";"), r];
}, Ut = (e) => {
...
}, xr = (e, t, n, r, o, s, a, c, i, u, d, l, w) => {
  let m = 0;
  return (h, f, g = { credentials: "omit" }) => {
    const p = d.get(h);
    if (p !== void 0 && p.has(f))
    ...
    const v = s(h), T = v.audioWorklet === void 0 ? o(f).then(([E, b]) => {
      const [y, _] = Bt(E, b), N = `${y};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${_}
})})(window,'_AWGS')`;
      return n(N);
    }).then(() => {
      const E = w._AWGS.pop();
      ...
      r(v.currentTime, v.sampleRate, () => E(class {
        ...
        if (_ !== void 0) {
          if (_.has(b))
            throw t();
          Dt(y), Ut(y.parameterDescriptors), _.set(b, y);
        } else
          Dt(y), Ut(y.parameterDescriptors), tt.set(v, /* @__PURE__ */ new Map([[b, y]]));
    ...
    return A === void 0 ? u.set(h, /* @__PURE__ */ new Map([[f, T]])) : A.set(f, T), T.then(() => {
      const E = d.get(h);
      E === void 0 ? d.set(h, /* @__PURE__ */ new Set([f])) : E.add(f);
    }).finally(() => {
      const E = u.get(h);
      E !== void 0 && E.delete(f);
    }), T;
  ...
  const o = K(e, t), s = Ve(o, (a) => a[0] === n && a[1] === r);
  ...
  !cn(e) && t.every((n) => n.size === 0) && ut(e);
}, Fr = (e, t, n, r, o, s, a, c, i, u, d, l, w) => {
  const m = /* @__PURE__ */ new WeakMap();
  return (h, f, g, p, A) => {
    const { activeInputs: v, passiveInputs: T } = s(f), { outputs: E } = s(h), b = c(h), y = (_) => {
      const N = i(f), I = i(h);
      if (_) {
        const M = an(T, h, g, p);
        e(v, h, M, !1), !A && !l(h) && n(I, N, g, p), w(f) && Pe(f);
      } else {
        const M = r(v, h, g, p);
        t(T, p, M, !1), !A && !l(h) && o(I, N, g, p);
        const U = a(f);
        if (U === 0)
          d(f) && rt(f, v);
        else {
          const R = m.get(f);
          R !== void 0 && clearTimeout(R), m.set(f, setTimeout(() => {
            d(f) && rt(f, v);
          }, U * 1e3));
        }
      }
    };
    return u(E, [f, g, p], (_) => _[0] === f && _[1] === g && _[2] === p, !0) ? (b.add(y), d(h) ? e(v, h, [g, p, y], !0) : t(T, p, [h, g, y], !0), !0) : !1;
  };
}, jr = (e) => (t, n, [r, o, s], a) => {
  const c = t.get(r);
  ...
  return !0;
}, ue = () => new DOMException("", "IndexSizeError"), qr = (e) => {
  ...
  return class ln {
    constructor(d) {
      ...
      const { length: l, numberOfChannels: w, sampleRate: m } = { ...zr, ...d };
      i === null && (i = new o(1, 1, 44100));
      const h = r !== null && t(s, s) ? new r({ length: l, numberOfChannels: w, sampleRate: m }) : i.createBuffer(w, l, m);
      if (h.numberOfChannels === 0)
        throw n();
      return typeof h.copyFromChannel != "function" ? (a(h), qr(h)) : t(Wt, () => Wt(h)) || c(h), e.add(h), h;
    }
    static [Symbol.hasInstance](d) {
      return d !== null && typeof d == "object" && Object.getPrototypeOf(d) === ln.prototype || e.has(d);
    }
  };
}, xe = -34028234663852886e22, lt = -xe, ae = (e) => ge.has(e), Yr = {
  buffer: null,
  channelCount: 2,
  ...
  loopStart: 0,
  playbackRate: 1
}, Hr = (e, t, n, r, o, s, a, c) => class extends e {
  constructor(u, d) {
    const l = s(u), w = { ...Yr, ...d }, m = o(l, w), h = a(l), f = h ? t() : null;
    super(u, !1, m, f), this._audioBufferSourceNodeRenderer = f, this._isBufferNullified = !1, this._isBufferSet = w.buffer !== null, this._nativeAudioBufferSourceNode = m, this._onended = null, this._playbackRate = n(this, h, m.playbackRate, lt, xe);
  }
  get buffer() {
  ...
  start(u = 0, d = 0, l) {
    if (this._nativeAudioBufferSourceNode.start(u, d, l), this._audioBufferSourceNodeRenderer !== null && (this._audioBufferSourceNodeRenderer.start = l === void 0 ? [u, d] : [u, d, l]), this.context.state !== "closed") {
      Pe(this);
      const w = () => {
        this._nativeAudioBufferSourceNode.removeEventListener("ended", w), ae(this) && ut(this);
      };
      this._nativeAudioBufferSourceNode.addEventListener("ended", w);
    }
  }
  stop(u = 0) {
  ...
  const i = async (u, d) => {
    ...
    return s.set(d, l), w ? await e(d, u.playbackRate, l.playbackRate) : await r(d, u.playbackRate, l.playbackRate), await o(u, d, l), l;
  };
  return {
    set start(u) {
      a = u;
...
}, Kr = (e) => "playbackRate" in e, Qr = (e) => "frequency" in e && "gain" in e, Jr = (e) => "offset" in e, eo = (e) => !("frequency" in e) && "gain" in e, to = (e) => "detune" in e && "frequency" in e && !("gain" in e), no = (e) => "pan" in e, z = (e) => K(Jt, e), Ae = (e) => K(tn, e), ot = (e, t) => {
  const { activeInputs: n } = z(e);
  n.forEach((o) => o.forEach(([s]) => {
    t.includes(e) || ot(s, [...t, e]);
  }));
  const r = Kr(e) ? [
    // Bug #149: Safari does not yet support the detune AudioParam.
    e.playbackRate
  ] : cn(e) ? Array.from(e.parameters.values()) : Qr(e) ? [e.Q, e.detune, e.frequency, e.gain] : Jr(e) ? [e.offset] : eo(e) ? [e.gain] : to(e) ? [e.detune, e.frequency] : no(e) ? [e.pan] : [];
  for (const o of r) {
    const s = Ae(o);
    s !== void 0 && s.activeInputs.forEach(([a]) => ot(a, t));
  }
  ae(e) && ut(e);
}, ro = (e) => {
  ot(e.destination, []);
}, oo = (e) => e === void 0 || typeof e == "number" || typeof e == "string" && (e === "balanced" || e === "interactive" || e === "playback"), so = (e, t, n, r, o, s, a, c) => class extends e {
  constructor(u, d) {
    const l = s(u), w = a(l), m = o(l, d, w), h = w ? t(c) : null;
    super(u, !1, m, h), this._isNodeOfNativeOfflineAudioContext = w, this._nativeAudioDestinationNode = m;
  }
  get channelCount() {
  ...
  const d = u.listener, l = () => {
    ...
    let _ = !1, N = [0, 0, -1, 0, 1, 0], I = [0, 0, 0];
    const M = () => {
      if (_)
        return;
      _ = !0;
      const B = r(u, 256, 9, 0);
      B.onaudioprocess = ({ inputBuffer: S }) => {
        const L = [
          s(S, E, 0),
          s(S, E, 1),
          s(S, E, 2),
        ...
        L.some((O, P) => O !== N[P]) && (d.setOrientation(...L), N = L);
        const D = [
          s(S, E, 6),
          s(S, E, 7),
          s(S, E, 8)
        ];
        D.some((O, P) => O !== I[P]) && (d.setPosition(...D), I = D);
      }, b.connect(B);
    }, U = (B) => (S) => {
      S !== N[B] && (N[B] = S, d.setOrientation(...N));
    }, R = (B) => (S) => {
      S !== I[B] && (I[B] = S, d.setPosition(...I));
    }, W = (B, S, L) => {
      const D = n(u, {
        channelCount: 1,
        channelCountMode: "explicit",
      ...
      D.connect(b, 0, B), D.start(), Object.defineProperty(D.offset, "defaultValue", {
        get() {
          return S;
        }
      });
      const O = e({ context: i }, y, D.offset, lt, xe);
      return c(O, "value", (P) => () => P.call(O), (P) => (x) => {
        try {
          P.call(O, x);
        } catch ($) {
          if ($.code !== 9)
        ...
        M(), y && L(x);
      }), O.cancelAndHoldAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.cancelAndHoldAtTime), O.cancelScheduledValues = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.cancelScheduledValues), O.exponentialRampToValueAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.exponentialRampToValueAtTime), O.linearRampToValueAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.linearRampToValueAtTime), O.setTargetAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.setTargetAtTime), O.setValueAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
      })(O.setValueAtTime), O.setValueCurveAtTime = /* @__PURE__ */ ((P) => y ? () => {
        throw o();
      } : (...x) => {
        const $ = P.apply(O, x);
        return M(), $;
  ...
  }, { forwardX: w, forwardY: m, forwardZ: h, positionX: f, positionY: g, positionZ: p, upX: A, upY: v, upZ: T } = d.forwardX === void 0 ? l() : d;
  return {
    get forwardX() {
      return w;
    },
  ...
  for (const r of e)
    if (r[0] === t && r[1] === n)
      return e.delete(r), r;
  return null;
}, co = (e, t, n) => Ve(e, (r) => r[0] === t && r[1] === n), hn = (e, t) => {
  if (!be(e).delete(t))
    throw new Error("Missing the expected event listener.");
}, pn = (e, t, n) => {
  const r = K(e, t), o = Ve(r, (s) => s[0] === n);
  return r.size === 0 && e.delete(t), o;
}, at = (e, t, n, r) => {
  dn(t) ? e.disconnect(t.inputs[r], n, 0) : e.disconnect(t, n, r);
}, H = (e) => K(en, e), ye = (e) => K(nn, e), ie = (e) => et.has(e), Ie = (e) => !ge.has(e), Ft = (e, t) => new Promise((n) => {
  if (t !== null)
    n(!0);
  else {
  ...
  const { activeInputs: o, passiveInputs: s } = Ae(t), { outputs: a } = z(e), c = be(e), i = (u) => {
    ...
    if (u) {
      const w = pn(s, e, n);
      Vt(o, e, w, !1), !r && !ie(e) && d.connect(l, n);
    } else {
      const w = co(o, e, n);
      xt(s, w, !1), !r && !ie(e) && d.disconnect(l, n);
    }
  };
  return le(a, [t, n], (u) => u[0] === t && u[1] === n, !0) ? (c.add(i), ae(e) ? Vt(o, e, [n, i], !0) : xt(s, [e, n, i], !0), !0) : !1;
}, fo = (e, t, n, r) => {
  ...
  const [s, a] = fo(e, n, r, o);
  if (s !== null && (hn(e, s), a && !t && !ie(e) && at(H(e), H(n), r, o)), ae(n)) {
  ...
  for (const o of n.outputs)
    Ce(o) ? dt(e, t, ...o) : ft(e, t, ...o), r.push(o[0]);
  return n.outputs.clear(), r;
}, mo = (e, t, n) => {
  const r = z(e), o = [];
  for (const s of r.outputs)
    s[1] === n && (Ce(s) ? dt(e, t, ...s) : ft(e, t, ...s), o.push(s[0]), r.outputs.delete(s));
  return o;
}, go = (e, t, n, r, o) => {
  const s = z(e);
  return Array.from(s.outputs).filter((a) => a[0] === n && (r === void 0 || a[1] === r) && (o === void 0 || a[2] === o)).map((a) => (Ce(a) ? dt(e, t, ...a) : ft(e, t, ...a), s.outputs.delete(a), a[0]));
}, wo = (e, t, n, r, o, s, a, c, i, u, d, l, w, m, h, f) => class extends u {
  constructor(p, A, v, T) {
    super(v), this._context = p, this._nativeAudioNode = v;
    const E = d(p);
    l(E) && n(Ft, () => Ft(E, f)) !== !0 && uo(v), en.set(this, v), on.set(this, /* @__PURE__ */ new Set()), p.state !== "closed" && A && Pe(this), e(this, T, v);
  }
  get channelCount() {
    return this._nativeAudioNode.channelCount;
  }
  set channelCount(p) {
    this._nativeAudioNode.channelCount = p;
  }
  get channelCountMode() {
    return this._nativeAudioNode.channelCountMode;
  }
  set channelCountMode(p) {
    this._nativeAudioNode.channelCountMode = p;
  }
  get channelInterpretation() {
    return this._nativeAudioNode.channelInterpretation;
  }
  set channelInterpretation(p) {
    this._nativeAudioNode.channelInterpretation = p;
  }
  get context() {
  ...
  connect(p, A = 0, v = 0) {
    if (A < 0 || A >= this._nativeAudioNode.numberOfOutputs)
      throw o();
    const T = d(this._context), E = h(T);
    if (w(p) || m(p))
      throw s();
    if (Be(p)) {
      const _ = H(p);
      try {
        const I = st(this._nativeAudioNode, _, A, v), M = Ie(this);
        (E || M) && this._nativeAudioNode.disconnect(...I), this.context.state !== "closed" && !M && Ie(p) && Pe(p);
      } catch (I) {
        throw I.code === 12 ? s() : I;
      }
      if (t(this, p, A, v, E)) {
  ...
  disconnect(p, A, v) {
    let T;
    const E = d(this._context), b = h(E);
    if (p === void 0)
      T = po(this, b);
    else if (typeof p == "number") {
      if (p < 0 || p >= this.numberOfOutputs)
        throw o();
      T = mo(this, b, p);
    } else {
      if (A !== void 0 && (A < 0 || A >= this.numberOfOutputs) || Be(p) && v !== void 0 && (v < 0 || v >= p.numberOfInputs))
        throw o();
      if (T = go(this, b, p, A, v), T.length === 0)
        throw s();
    }
    for (const y of T) {
      const _ = i([this], y);
...
}, _o = (e, t, n, r, o, s, a, c, i, u, d, l, w) => (m, h, f, g = null, p = null) => {
  const A = f.value, v = new kr(A), T = h ? r(v) : null, E = {
    get defaultValue() {
      return A;
    },
    get maxValue() {
    ...
    get minValue() {
      return p === null ? f.minValue : p;
    },
    get value() {
      return f.value;
    },
    set value(b) {
      f.value = b, E.setValueAtTime(b, m.context.currentTime);
    },
    cancelAndHoldAtTime(b) {
      if (typeof f.cancelAndHoldAtTime == "function")
        T === null && v.flush(m.context.currentTime), v.add(o(b)), f.cancelAndHoldAtTime(b);
      else {
        const y = Array.from(v).pop();
        T === null && v.flush(m.context.currentTime), v.add(o(b));
    ...
    cancelScheduledValues(b) {
      return T === null && v.flush(m.context.currentTime), v.add(s(b)), f.cancelScheduledValues(b), E;
    },
    ...
    setTargetAtTime(b, y, _) {
      return T === null && v.flush(m.context.currentTime), v.add(i(b, y, _)), f.setTargetAtTime(b, y, _), E;
    },
    setValueAtTime(b, y) {
      return T === null && v.flush(m.context.currentTime), v.add(u(b, y)), f.setValueAtTime(b, y), E;
    },
    setValueCurveAtTime(b, y, _) {
      const N = b instanceof Float32Array ? b : new Float32Array(b);
      if (l !== null && l.name === "webkitAudioContext") {
        const I = y + _, M = m.context.sampleRate, U = Math.ceil(y * M), R = Math.floor(I * M), W = R - U, B = new Float32Array(W);
        for (let L = 0; L < W; L += 1) {
          const D = (N.length - 1) / _ * ((U + L) / M - y), O = Math.floor(D), P = Math.ceil(D);
          B[L] = O === P ? N[O] : (1 - (D - O)) * N[O] + (1 - (P - D)) * N[P];
        }
        T === null && v.flush(m.context.currentTime), v.add(d(B, y, _)), f.setValueCurveAtTime(B, y, _);
        const S = R / M;
        S < I && w(E, B[B.length - 1], S), w(E, N[N.length - 1], I);
      } else
        T === null && v.flush(m.context.currentTime), v.add(d(N, y, _)), f.setValueCurveAtTime(N, y, _);
      return E;
    }
  };
  return n.set(E, f), t.set(E, m), e(E, T), E;
}, vo = (e) => ({
  replay(t) {
    for (const n of e)
...
const yo = {
  ...
  parameterData: {},
  processorOptions: {}
}, Eo = (e, t, n, r, o, s, a, c, i, u, d, l, w, m) => class extends t {
  constructor(f, g, p) {
    var A;
    const v = c(f), T = i(v), E = d({ ...yo, ...p });
    w(E);
    const b = tt.get(v), y = b?.get(g), _ = T || v.state !== "closed" ? v : (A = a(v)) !== null && A !== void 0 ? A : v, N = o(_, T ? null : f.baseLatency, u, g, y, E), I = T ? r(g, E, y) : null;
    super(f, !0, N, I);
    const M = [];
    N.parameters.forEach((R, W) => {
      const B = n(this, T, R);
      M.push([W, B]);
    }), this._nativeAudioWorkletNode = N, this._onprocessorerror = null, this._parameters = new mn(M), T && e(v, this);
    const { activeInputs: U } = s(this);
    l(N, U);
  }
  ...
  set onprocessorerror(f) {
    const g = typeof f == "function" ? m(this, f) : null;
    this._nativeAudioWorkletNode.onprocessorerror = g;
    const p = this._nativeAudioWorkletNode.onprocessorerror;
    this._onprocessorerror = p !== null && p === g ? f : p;
  }
  get parameters() {
...
const gn = (e, t, n, r, o) => {
  ...
  const n = K(nt, e), r = H(t);
  return K(n, r);
}, Ao = async (e, t, n, r, o, s, a) => {
  const c = t === null ? Math.ceil(e.context.length / 128) * 128 : t.length, i = r.channelCount * r.numberOfInputs, u = o.reduce((g, p) => g + p, 0), d = u === 0 ? null : n.createBuffer(u, c, n.sampleRate);
  if (s === void 0)
    throw new Error("Missing the processor constructor.");
  const l = z(e), w = await bo(n, e), m = We(r.numberOfInputs, r.channelCount), h = We(r.numberOfOutputs, o), f = Array.from(e.parameters.keys()).reduce((g, p) => ({ ...g, [p]: new Float32Array(128) }), {});
  for (let g = 0; g < c; g += 128) {
    if (r.numberOfInputs > 0 && t !== null)
      for (let p = 0; p < r.numberOfInputs; p += 1)
        for (let A = 0; A < r.channelCount; A += 1)
          De(t, m[p], A, A, g);
    s.parameterDescriptors !== void 0 && t !== null && s.parameterDescriptors.forEach(({ name: p }, A) => {
      De(t, f, p, i + A, g);
    });
    for (let p = 0; p < r.numberOfInputs; p += 1)
      for (let A = 0; A < o[p]; A += 1)
        h[p][A].byteLength === 0 && (h[p][A] = new Float32Array(128));
    try {
      const p = m.map((v, T) => l.activeInputs[T].size === 0 ? [] : v), A = a(g / n.sampleRate, n.sampleRate, () => w.process(p, h, f));
      if (d !== null)
  ...
  return d;
}, Co = (e, t, n, r, o, s, a, c, i, u, d, l, w, m, h, f) => (g, p, A) => {
  const v = /* @__PURE__ */ new WeakMap();
  let T = null;
  const E = async (b, y) => {
    let _ = d(b), N = null;
    const I = un(_, y), M = Array.isArray(p.outputChannelCount) ? p.outputChannelCount : Array.from(p.outputChannelCount);
    if (l === null) {
      const U = M.reduce((S, L) => S + L, 0), R = o(y, {
        channelCount: Math.max(1, U),
        channelCountMode: "explicit",
        channelInterpretation: "discrete",
        numberOfOutputs: Math.max(1, U)
      }), W = [];
      for (let S = 0; S < b.numberOfOutputs; S += 1)
        W.push(r(y, {
          channelCount: 1,
          channelCountMode: "explicit",
          channelInterpretation: "speakers",
      ...
      B.connect = t.bind(null, W), B.disconnect = i.bind(null, W), N = [R, W, B];
    } else I || (_ = new l(y, g));
    if (v.set(y, N === null ? _ : N[2]), N !== null) {
      if (T === null) {
        if (A === void 0)
          throw new Error("Missing the processor constructor.");
        if (w === null)
          throw new Error("Missing the native OfflineAudioContext constructor.");
        const L = b.channelCount * b.numberOfInputs, D = A.parameterDescriptors === void 0 ? 0 : A.parameterDescriptors.length, O = L + D;
        T = Ao(b, O === 0 ? null : await (async () => {
          const x = new w(
            O,
          ...
          for (let j = 0; j < p.numberOfInputs; j += 1)
            $.push(a(x, {
              channelCount: p.channelCount,
              channelCountMode: p.channelCountMode,
              channelInterpretation: p.channelInterpretation,
          ...
          const he = await Promise.all(Array.from(b.parameters.values()).map(async (j) => {
            ...
            return await m(x, j, X.offset), X;
          })), pe = r(x, {
            channelCount: 1,
            channelCountMode: "explicit",
            channelInterpretation: "speakers",
            numberOfInputs: Math.max(1, L + D)
          });
          for (let j = 0; j < p.numberOfInputs; j += 1) {
            $[j].connect(fe[j]);
            for (let X = 0; X < p.channelCount; X += 1)
              fe[j].connect(pe, X, j * p.channelCount + X);
          }
          for (const [j, X] of he.entries())
            X.connect(pe, 0, L + j), X.start(0);
          return pe.connect(x.destination), await Promise.all($.map((j) => h(b, x, j))), f(x);
        })(), y, p, M, A, u);
      }
      const U = await T, R = n(y, {
        buffer: null,
        channelCount: 2,
        channelCountMode: "max",
        channelInterpretation: "speakers",
      ...
      U !== null && (R.buffer = U, R.start(0)), R.connect(W);
      for (let L = 0, D = 0; L < b.numberOfOutputs; L += 1) {
        const O = B[L];
        for (let P = 0; P < M[L]; P += 1)
          W.connect(O, D + P, P);
        D += M[L];
      }
      return S;
    ...
    if (I)
      for (const [U, R] of b.parameters.entries())
        await e(
          y,
          R,
...
}, Mo = (e) => (t, n, r) => e(n, t, r), No = (e) => (t, n, r = 0, o = 0) => {
  const s = t[r];
  if (s === void 0)
    throw e();
  return Ue(n) ? s.connect(n, 0, o) : s.connect(n, 0);
}, Oo = (e) => (t) => (e[0] = t, e[0]), ko = (e, t, n, r, o, s, a, c) => (i, u) => {
  const d = t.get(i);
  if (d === void 0)
    throw new Error("Missing the expected cycle count.");
  const l = s(i.context), w = c(l);
  if (d === u) {
    if (t.delete(i), !w && a(i)) {
      const m = r(i), { outputs: h } = n(i);
      for (const f of h)
        if (Ce(f)) {
          const g = r(f[0]);
          e(m, g, f[1], f[2]);
    ...
    t.set(i, d - u);
}, Io = (e) => (t, n, r, o) => e(t[o], (s) => s[0] === n && s[1] === r), So = (e) => (t, n) => {
  e(t).delete(n);
}, Ro = (e) => "delayTime" in e, Lo = (e, t, n) => function r(o, s) {
  ...
  if (r === void 0)
    throw e();
  return r;
}, Po = (e) => (t, n = void 0, r = void 0, o = 0) => n === void 0 ? t.forEach((s) => s.disconnect()) : typeof n == "number" ? ke(e, t, n).disconnect() : Ue(n) ? r === void 0 ? t.forEach((s) => s.disconnect(n)) : o === void 0 ? ke(e, t, r).disconnect(n, 0) : ke(e, t, r).disconnect(n, 0, o) : r === void 0 ? t.forEach((s) => s.disconnect(n)) : ke(e, t, r).disconnect(n, 0), Bo = (e) => (t) => new Promise((n, r) => {
  if (e === null) {
    r(new SyntaxError());
    return;
  }
  ...
  if (o === null)
    ...
    e.onerror = (d, l, w, m, h) => {
      if (l === c || l === e.location.href && w === 1 && m === 1)
        return u(), r(h), !1;
      if (i !== null)
        return i(d, l, w, m, h);
    }, s.onerror = () => {
  ...
  return n.renderer;
}, Go = (e) => (t) => e.get(t), Z = () => new DOMException("", "InvalidStateError"), $o = (e) => (t) => {
  const n = e.get(t);
  if (n === void 0)
    throw Z();
  return n;
  ...
  return n;
}, Xo = () => new DOMException("", "InvalidAccessError"), Yo = (e, t, n, r, o, s) => (a) => (c, i) => {
  const u = e.get(c);
  if (u === void 0) {
    if (!a && s(c)) {
    ...
    e.set(c, u + i);
}, Ho = (e) => (t) => e !== null && t instanceof e, Zo = (e) => (t) => e !== null && typeof e.AudioNode == "function" && t instanceof e.AudioNode, Ko = (e) => (t) => e !== null && typeof e.AudioParam == "function" && t instanceof e.AudioParam, Qo = (e) => (t) => e !== null && t instanceof e, Jo = (e) => e !== null && e.isSecureContext, es = (e, t, n, r) => class extends e {
  constructor(s, a) {
    const c = n(s), i = t(c, a);
    if (r(c))
      throw new TypeError();
  ...
  close() {
    return this.state === "closed" ? this._nativeAudioContext.close().then(() => {
      ...
      this._nativeGainNode !== null && this._nativeOscillatorNode !== null && (this._nativeOscillatorNode.stop(), this._nativeGainNode.disconnect(), this._nativeOscillatorNode.disconnect()), ro(this);
    }));
  }
  resume() {
...
}, ns = (e, t, n, r, o, s) => class extends n {
  constructor(c, i) {
  ...
  return n.connect = /* @__PURE__ */ ((a) => (c, i = 0, u = 0) => {
    ...
    if (c === void 0)
      ...
      for (const w of s)
        w[0] === c && (i === void 0 || w[1] === i) && (u === void 0 || w[2] === u) && s.delete(w);
    }
    const l = s.size === 0;
    d && l && o();
  })(n.disconnect), n;
...
}, os = (e) => e === null ? null : e.hasOwnProperty("AudioBuffer") ? e.AudioBuffer : null, ht = (e, t, n) => {
  const r = t[n];
...
}, as = (e, t, n, r, o, s, a, c, i, u, d) => (l, w) => {
  const m = l.createBufferSource();
  return Te(m, w), ht(m, w, "playbackRate"), se(m, w, "buffer"), se(m, w, "loop"), se(m, w, "loopEnd"), se(m, w, "loopStart"), t(n, () => n(l)) || ss(m), t(r, () => r(l)) || i(m), t(o, () => o(l)) || u(m, l), t(s, () => s(l)) || wn(m), t(a, () => a(l)) || d(m, l), t(c, () => c(l)) || _n(m), e(l, m), m;
}, is = (e) => e === null ? null : e.hasOwnProperty("AudioContext") ? e.AudioContext : e.hasOwnProperty("webkitAudioContext") ? e.webkitAudioContext : null, cs = (e, t) => (n, r, o) => {
...
}, us = (e) => e === null ? null : e.hasOwnProperty("AudioWorkletNode") ? e.AudioWorkletNode : null, ls = (e) => {
...
}, ds = (e, t, n, r, o) => (s, a, c, i, u, d) => {
  if (c !== null)
    try {
      const l = new c(s, i, d), w = /* @__PURE__ */ new Map();
      let m = null;
      if (Object.defineProperties(l, {
        ...
        onprocessorerror: {
          get: () => m,
          set: (h) => {
            typeof m == "function" && l.removeEventListener("processorerror", m), m = typeof h == "function" ? h : null, typeof m == "function" && l.addEventListener("processorerror", m);
          }
        }
      }), l.addEventListener = /* @__PURE__ */ ((h) => (...f) => {
        ...
        return h.call(l, "error", f[1], f[2]), h.call(l, ...f);
      })(l.addEventListener), l.removeEventListener = /* @__PURE__ */ ((h) => (...f) => {
        if (f[0] === "processorerror") {
          const g = w.get(f[1]);
          g !== void 0 && (w.delete(f[1]), f[1] = g);
        }
        return h.call(l, "error", f[1], f[2]), h.call(l, f[0], f[1], f[2]);
        ...
        return l.connect(h).connect(s.destination), o(l, () => h.disconnect(), () => h.connect(s.destination));
      }
      return l;
    } catch (l) {
      throw l.code === 11 ? r() : l;
  ...
  if (u === void 0)
    throw r();
  return ls(d), t(s, a, u, d);
}, fs = (e, t) => e === null ? 512 : Math.max(512, Math.min(16384, Math.pow(2, Math.round(Math.log2(e * t))))), hs = (e) => new Promise((t, n) => {
  ...
  let o = nt.get(e);
  o === void 0 && (o = /* @__PURE__ */ new WeakMap(), nt.set(e, o));
  const s = ps(n, r);
  return o.set(t, s), s;
}, gs = (e, t, n, r, o, s, a, c, i, u, d, l, w) => (m, h, f, g) => {
  if (g.numberOfInputs === 0 && g.numberOfOutputs === 0)
    throw i();
  const p = Array.isArray(g.outputChannelCount) ? g.outputChannelCount : Array.from(g.outputChannelCount);
  if (p.some((C) => C < 1))
    throw i();
  if (p.length !== g.numberOfOutputs)
    throw t();
  if (g.channelCountMode !== "explicit")
    throw i();
  const A = g.channelCount * g.numberOfInputs, v = p.reduce((C, k) => C + k, 0), T = f.parameterDescriptors === void 0 ? 0 : f.parameterDescriptors.length;
  if (A + T > 6 || v > 6)
    throw i();
  ...
  for (let C = 0; C < g.numberOfInputs; C += 1) {
    ...
    for (let k = 0; k < g.channelCount; k += 1)
      y[C].connect(N, k, C * g.channelCount + k);
  }
  const W = new mn(f.parameterDescriptors === void 0 ? [] : f.parameterDescriptors.map(({ name: C }, k) => {
    const q = _[k];
    return q.connect(N, 0, A + k), q.start(0), [C, q.offset];
  }));
  N.connect(M);
  let B = g.channelInterpretation, S = null;
  const L = g.numberOfOutputs === 0 ? [M] : R, D = {
    get bufferSize() {
      return I;
    },
    get channelCount() {
    ...
    set onprocessorerror(C) {
      typeof S == "function" && D.removeEventListener("processorerror", S), S = typeof C == "function" ? C : null, typeof S == "function" && D.addEventListener("processorerror", S);
    },
    get parameters() {
      return W;
    },
    ...
    addEventListener(...C) {
      return M.addEventListener(C[0], C[1], C[2]);
    },
    connect: e.bind(null, L),
    disconnect: u.bind(null, L),
    dispatchEvent(...C) {
      return M.dispatchEvent(C[0]);
    },
    removeEventListener(...C) {
      return M.removeEventListener(C[0], C[1], C[2]);
    }
  }, O = /* @__PURE__ */ new Map();
  ...
  Object.defineProperty(E.port1, "onmessage", {
    get: () => P,
    set: (C) => {
      typeof P == "function" && E.port1.removeEventListener("message", P), P = typeof C == "function" ? C : null, typeof P == "function" && (E.port1.addEventListener("message", P), E.port1.start());
    }
  }), f.prototype.port = E.port1;
  let x = null;
  ms(m, D, f, g).then((C) => x = C);
  const fe = We(g.numberOfInputs, g.channelCount), he = We(g.numberOfOutputs, p), pe = f.parameterDescriptors === void 0 ? [] : f.parameterDescriptors.reduce((C, { name: k }) => ({ ...C, [k]: new Float32Array(128) }), {});
  let j = !0;
  const X = () => {
    g.numberOfOutputs > 0 && M.disconnect(U);
    for (let C = 0, k = 0; C < g.numberOfOutputs; C += 1) {
      const q = R[C];
      for (let F = 0; F < p[C]; F += 1)
        U.disconnect(q, k + F, F);
      k += p[C];
    }
  }, Me = /* @__PURE__ */ new Map();
  M.onaudioprocess = ({ inputBuffer: C, outputBuffer: k }) => {
    if (x !== null) {
      const q = l(D);
      for (let F = 0; F < I; F += 128) {
        for (let V = 0; V < g.numberOfInputs; V += 1)
          for (let G = 0; G < g.channelCount; G += 1)
            De(C, fe[V], G, G, F);
        f.parameterDescriptors !== void 0 && f.parameterDescriptors.forEach(({ name: V }, G) => {
          De(C, pe, V, A + G, F);
        });
        for (let V = 0; V < g.numberOfInputs; V += 1)
          for (let G = 0; G < p[V]; G += 1)
            he[V][G].byteLength === 0 && (he[V][G] = new Float32Array(128));
        try {
          const V = fe.map((Y, te) => {
            if (q[te].size > 0)
              return Me.set(te, I / 128), Y;
            const Ye = Me.get(te);
            return Ye === void 0 ? [] : (Y.every((qn) => qn.every((zn) => zn === 0)) && (Ye === 1 ? Me.delete(te) : Me.set(te, Ye - 1)), Y);
          });
          j = d(m.currentTime + F / m.sampleRate, m.sampleRate, () => x.process(V, he, pe));
          for (let Y = 0, te = 0; Y < g.numberOfOutputs; Y += 1) {
            for (let ve = 0; ve < p[Y]; ve += 1)
              gn(k, he[Y], ve, te + ve, F);
            te += p[Y];
          }
        } catch (V) {
          j = !1, D.dispatchEvent(new ErrorEvent("processorerror", {
            colno: V.colno,
            filename: V.filename,
            lineno: V.lineno,
            message: V.message
        ...
        if (!j) {
          for (let V = 0; V < g.numberOfInputs; V += 1) {
            b[V].disconnect(y[V]);
            for (let G = 0; G < g.channelCount; G += 1)
              y[F].disconnect(N, G, V * g.channelCount + G);
          }
          if (f.parameterDescriptors !== void 0) {
            const V = f.parameterDescriptors.length;
            for (let G = 0; G < V; G += 1) {
              const Y = _[G];
              Y.disconnect(N, 0, A + G), Y.stop();
            }
          }
          N.disconnect(M), M.onaudioprocess = null, ze ? X() : Tt();
          break;
        }
      }
    }
  ...
  const Xe = a(m, {
    ...
    channelInterpretation: "discrete",
    gain: 0
  }), Ct = () => M.connect(Xe).connect(m.destination), Tt = () => {
    M.disconnect(Xe), Xe.disconnect();
  }, Gn = () => {
    if (j) {
      Tt(), g.numberOfOutputs > 0 && M.connect(U);
      for (let C = 0, k = 0; C < g.numberOfOutputs; C += 1) {
        const q = R[C];
        for (let F = 0; F < p[C]; F += 1)
          U.connect(q, k + F, F);
  ...
  return Te(n, t), _s(n), n;
}, vs = (e, t, n, r, o) => (s, a) => {
  if (s.createConstantSource === void 0)
    return n(s, a);
  const c = s.createConstantSource();
  return Te(c, a), ht(c, a, "offset"), t(r, () => r(s)) || wn(c), t(o, () => o(s)) || _n(c), e(s, c), c;
}, yn = (e, t) => (e.connect = t.connect.bind(t), e.disconnect = t.disconnect.bind(t), e), ys = (e, t, n, r) => (o, { offset: s, ...a }) => {
  ...
  const l = {
    ...
    addEventListener(...h) {
      return i.addEventListener(h[0], h[1], h[2]);
    },
    dispatchEvent(...h) {
      return i.dispatchEvent(h[0]);
    },
    removeEventListener(...h) {
      return i.removeEventListener(h[0], h[1], h[2]);
    },
    start(h = 0) {
      i.start.call(i, h);
    },
  ...
  }, w = () => i.connect(u), m = () => i.disconnect(u);
  return e(o, i), r(yn(l, u), w, m);
}, oe = (e, t) => {
  const n = e.createGain();
  return Te(n, t), ht(n, t, "gain"), n;
}, Es = (e, { mediaStream: t }) => {
...
}, bs = (e) => e === null ? null : e.hasOwnProperty("OfflineAudioContext") ? e.OfflineAudioContext : e.hasOwnProperty("webkitOfflineAudioContext") ? e.webkitOfflineAudioContext : null, pt = (e, t, n, r) => e.createScriptProcessor(t, n, r), de = () => new DOMException("", "NotSupportedError"), As = (e, t) => (n, r, o) => (e(r).replay(o), t(r, n, o)), Cs = (e, t, n) => async (r, o, s) => {
  const a = e(r);
  await Promise.all(a.activeInputs.map((c, i) => Array.from(c).map(async ([u, d]) => {
    const w = await t(u).render(u, o), m = r.context.destination;
    !n(u) && (r !== m || !n(r)) && w.connect(s, d, i);
  })).reduce((c, i) => [...c, ...i], []));
}, Ts = (e, t, n) => async (r, o, s) => {
  const a = t(r);
  await Promise.all(Array.from(a.activeInputs).map(async ([c, i]) => {
    const d = await e(c).render(c, o);
    n(c) || d.connect(s, i);
  }));
}, Ms = (e, t, n, r) => (o) => e(jt, () => jt(o)) ? Promise.resolve(e(r, r)).then((s) => {
  if (!s) {
    const a = n(o, 512, 0, 1);
    o.oncomplete = () => {
...
}, Ss = () => new DOMException("", "UnknownError"), Rs = () => typeof window > "u" ? null : window, Ls = (e, t) => (n) => {
...
}, Ds = (e, t, n) => e.copyFromChannel === void 0 ? e.getChannelData(n)[0] : (e.copyFromChannel(t, n), t[0]), mt = (e, t, n, r) => {
  let o = e;
...
}, zs = Ur(le), Xs = jr(le), Ys = Io(Ve), Hs = /* @__PURE__ */ new WeakMap(), Zs = Fo(Hs), we = To(/* @__PURE__ */ new Map(), /* @__PURE__ */ new WeakMap()), Q = Rs(), Cn = xo(z), gt = Cs(z, Cn, ie), ce = $o(rn), _e = bs(Q), ee = Qo(_e), Tn = /* @__PURE__ */ new WeakMap(), Mn = Uo(Fe), je = is(Q), Ks = Ho(je), Nn = Zo(Q), Qs = Ko(Q), Ee = us(Q), Ge = wo(Dr(Jt), Fr(zs, Xs, st, Ys, at, z, Zs, be, H, le, ae, ie, Ie), we, Yo(et, at, z, H, ye, ae), ue, Xo, de, ko(st, et, z, H, ye, ce, ae, ee), Lo(Tn, z, K), Mn, ce, Ks, Nn, Qs, ee, Ee), Js = /* @__PURE__ */ new WeakSet(), Gt = os(Q), On = Oo(new Uint32Array(1)), ea = Ls(On, ue), ta = Ps(On), na = Xr(Js, we, de, Gt, _e, Os(Gt), ea, ta), wt = Gr(oe), kn = Ts(Cn, Ae, ie), In = Mo(kn), $e = as(wt, we, Vs, xs, Fs, bn, js, An, $s, Bs(mt), qs), Sn = As(jo(Ae), kn), ra = Zr(In, $e, H, Sn, gt), _t = _o(Wr(tn), Tn, nn, vo, Ir, Sr, Rr, Lr, Pr, Ke, Zt, je, En), oa = Hr(Ge, ra, _t, Z, $e, ce, ee, Fe), sa = so(Ge, ao, ue, Z, cs(oe, mt), ce, ee, gt), qe = rs(le, Nn), aa = Us(Z, qe), vt = ws(je, aa), ia = ys(wt, $e, oe, qe), yt = vs(wt, we, ia, bn, An), ca = Ms(we, oe, pt, Is(oe, _e)), ua = io(_t, vt, yt, pt, de, Ds, ee, mt), Rn = /* @__PURE__ */ new WeakMap(), la = ns(sa, ua, Mn, ee, Rn, Fe), Ln = Jo(Q), Et = Do(Q), Pn = /* @__PURE__ */ new WeakMap(), da = qo(Pn, _e), $t = Ln ? xr(
  we,
  de,
  Bo(Q),
  Et,
  ...
  Q
) : void 0, fa = es(Ge, Es, ce, ee), Bn = zo(Rn), ha = $r(Bn), Un = No(ue), pa = So(Bn), Dn = Po(ue), Wn = /* @__PURE__ */ new WeakMap(), ma = Vo(Wn, K), ga = gs(Un, ue, Z, vt, vn, yt, oe, pt, de, Dn, Et, ma, qe), wa = ds(Z, ga, oe, de, qe), _a = Co(In, Un, $e, vt, vn, yt, oe, pa, Dn, Et, H, Ee, _e, Sn, gt, ca), va = Go(Pn), ya = Ns(Wn), qt = Ln ? Eo(ha, Ge, _t, _a, wa, z, va, ce, ee, Ee, Ws, ya, Gs, Fe) : void 0, Ea = ts(Z, de, Ss, la, je), Vn = "Missing AudioWorklet support. Maybe this is not running in a secure context.", ba = async (e, t, n, r, o) => {
  const { encoderId: s, port: a } = await Xt(o, t.sampleRate);
  if (qt === void 0)
    throw new Error(Vn);
  const c = new oa(t, { buffer: e }), i = new fa(t, { mediaStream: r }), u = Mr(qt, t, { channelCount: n });
  return { audioBufferSourceNode: c, encoderId: s, mediaStreamAudioSourceNode: i, port: a, recorderAudioWorkletNode: u };
}, Aa = (e, t, n, r) => (o, s, a) => {
  var c;
  const i = (c = s.getAudioTracks()[0]) === null || c === void 0 ? void 0 : c.getSettings().sampleRate, u = new Ea({ latencyHint: "playback", sampleRate: i }), d = Math.max(1024, Math.ceil(u.baseLatency * u.sampleRate)), l = new na({ length: d, sampleRate: u.sampleRate }), w = [], m = Tr((_) => {
    if ($t === void 0)
      throw new Error(Vn);
    return $t(u, _);
  });
  let h = null, f = null, g = null, p = null, A = !0;
  const v = (_) => {
    o.dispatchEvent(e("dataavailable", { data: new Blob(_, { type: a }) }));
  }, T = async (_, N) => {
    const I = await Se(_, N);
    g === null ? w.push(...I) : (v(I), p = T(_, N));
  }, E = () => (A = !0, u.resume()), b = () => {
    g !== null && (h !== null && (s.removeEventListener("addtrack", h), s.removeEventListener("removetrack", h)), f !== null && clearTimeout(f), g.then(async ({ encoderId: _, mediaStreamAudioSourceNode: N, recorderAudioWorkletNode: I }) => {
      p !== null && (p.catch(() => {
      }), p = null), await I.stop(), N.disconnect(I);
      const M = await Se(_, null);
      g === null && await y(), v([...w, ...M]), w.length = 0, o.dispatchEvent(new Event("stop"));
    }), g = null);
  }, y = () => (A = !1, u.suspend());
  return y(), {
    get mimeType() {
    ...
    start(_) {
      ...
      const I = s.getAudioTracks(), M = I.length === 0 ? 2 : (N = I[0].getSettings().channelCount) !== null && N !== void 0 ? N : 2;
      g = Promise.all([
        E(),
        m.then(() => ba(l, u, M, s, a))
      ]).then(async ([, { audioBufferSourceNode: R, encoderId: W, mediaStreamAudioSourceNode: B, port: S, recorderAudioWorkletNode: L }]) => (B.connect(L), await new Promise((D) => {
        R.onended = D, R.connect(L), R.start(u.currentTime + d / u.sampleRate);
      }), R.disconnect(L), await L.record(S), _ !== void 0 && (p = T(W, _)), { encoderId: W, mediaStreamAudioSourceNode: B, recorderAudioWorkletNode: L }));
      const U = s.getTracks();
      h = () => {
        b(), o.dispatchEvent(new ErrorEvent("error", { error: t() }));
      }, s.addEventListener("addtrack", h), s.addEventListener("removetrack", h), f = setInterval(() => {
        const R = s.getTracks();
        (R.length !== U.length || R.some((W, B) => W !== U[B])) && h !== null && h();
      }, 1e3);
    },
    stop: b
  };
...
const Ca = (e, t, n) => (r, o, s, a) => {
  const c = [], i = new o(s, { mimeType: "audio/webm;codecs=pcm" });
  let u = null, d = () => {
  };
  const l = (h) => {
    r.dispatchEvent(e("dataavailable", { data: new Blob(h, { type: a }) }));
  }, w = async (h, f) => {
    const g = await Se(h, f);
    i.state === "inactive" ? c.push(...g) : (l(g), u = w(h, f));
  }, m = () => {
    i.state !== "inactive" && (u !== null && (u.catch(() => {
    }), u = null), d(), d = () => {
    }, i.stop());
  };
  return i.addEventListener("error", (h) => {
    m(), r.dispatchEvent(new ErrorEvent("error", {
      error: h.error
    }));
    ...
    start(h) {
      ...
      if (f !== void 0 && i.state === "inactive") {
        const { channelCount: g, sampleRate: p } = f.getSettings();
        if (g === void 0)
          throw new Error("The channelCount is not defined.");
        if (p === void 0)
          throw new Error("The sampleRate is not defined.");
        let A = !1, v = !1, T = 0, E = Xt(a, p);
        d = () => {
          v = !0;
        };
        const b = Ht(i, "dataavailable")(({ data: y }) => {
          T += 1, E = E.then(async ({ dataView: _ = null, elementType: N = null, encoderId: I, port: M }) => {
            const U = await y.arrayBuffer();
            T -= 1;
            const R = _ === null ? new Ze([U]) : new Ze([..._.buffers, U], _.byteOffset);
            if (!A && i.state === "recording" && !v) {
              const D = n(R, 0);
              if (D === null)
                return { dataView: R, elementType: N, encoderId: I, port: M };
              const { value: O } = D;
              if (O !== 172351395)
                return { dataView: _, elementType: N, encoderId: I, port: M };
              A = !0;
            }
            const { currentElementType: W, offset: B, contents: S } = t(R, N, g), L = B < R.byteLength ? new Ze(R.buffers, R.byteOffset + B) : null;
            return S.forEach((D) => M.postMessage(D, D.map(({ buffer: O }) => O))), T === 0 && (i.state === "inactive" || v) && (Se(I, null).then((D) => {
              l([...c, ...D]), c.length = 0, r.dispatchEvent(new Event("stop"));
            }), M.postMessage([]), M.close(), b()), { dataView: L, elementType: W, encoderId: I, port: M };
          });
        });
        h !== void 0 && E.then(({ encoderId: y }) => u = w(y, h));
      }
      i.start(100);
    },
    stop: m
  };
}, Ta = () => typeof window > "u" ? null : window, xn = (e, t) => {
  if (t >= e.byteLength)
    return null;
...
}, Fn = [], bt = Ta(), Na = cr(bt), jn = tr(Na), Oa = Aa(jn, sr, ar, Yt), At = hr(xn), ka = dr(At), Ia = fr(At), Sa = nr(ka, Ia), Ra = Ca(jn, Sa, At), La = or(bt), Pa = lr(bt), Xa = ir(ur, Yt, Oa, Ra, Fn, rr(La, Ma), Pa), Ya = async (e) => {
  Fn.push(await er(e));
};
export {
  Xa as MediaRecorder,
